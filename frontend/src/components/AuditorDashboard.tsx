            ...
            if (selectedApp) {
              ...
              try {
                await addMonitoringLoan({
                  ...
                  complex_id: selectedApp.complex_id ?? null,
                  area_id: selectedApp.area_id ?? null,
                  prior_claims:
                    (data.property_rights_info.max_bond_amount || 0) +
                    (data.property_rights_info.tenant_deposit || 0),
                });
              } catch (err) {
